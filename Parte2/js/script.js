      /*
        ...
        */
          ...
          let valores= document.getElementById("btn_mayusculas").addEventListener("click",minusculas)
          ...
          valores.addEventListener("btn_mayusculas",hacerClick)
    ...
    */
   let edad=document.getElementById("btn_añoshumano").addEventListener("click",calculateDogAge)
   
   function calculateDogAge(e){
    e.preventDefault()
    let aPerro=parseInt(document.getElementById("edad_humano").value)*7
    document.getElementById("edad_perro").value=aPerro
   }
     ...
     */
    let pokemon=document.getElementById("btn_muestra").addEventListener("click")